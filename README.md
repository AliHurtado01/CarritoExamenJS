Aquí tienes una propuesta de README.md profesional y bien estructurado para tu proyecto. He incluido las secciones estándar de GitHub (Descripción, características, lógica de negocio y cómo usarlo), basándome en el código proporcionado.

Puedes copiar y pegar el siguiente código Markdown directamente en tu repositorio.
...
Asegúrate de tener los archivos index.html y script.js en la misma carpeta.
